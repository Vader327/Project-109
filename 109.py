...
for x in range(len(file_data)):
  data.append(float(file_data[x][6]))
...
print(str(len(list_of_data_within_1_std_deviation)*100.0/len(data)) + "% of data lies within 1 standard deviation")
print(str(len(list_of_data_within_2_std_deviation)*100.0/len(data)) + "% of data lies within 2 standard deviation")
print(str(len(list_of_data_within_3_std_deviation)*100.0/len(data)) + "% of data lies within 3 standard deviation")
